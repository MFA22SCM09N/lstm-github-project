...
Step3: Deploying LSTM to gcloud platform
       ...
       2. Steps to follow while creating LSTM gcloud project:
            ...
            2. After creating the LSTM gcloud project follow the below steps:
               a. go to gcloud storage of LSTM gcloud project then click on create bucket. (lstm-service)
               b. then add name to your bucket (bucket name should be unique) (lstm_bucket_mehak)click on continue.
            ...
            4. Then select your LSTM created project, in service account details add service name "your unique service name"(service name should be unique) (lstm_service_unique) and click on "create and 
            ...
            7. Then, on cmd terminal type "set GOOGLE_APPLICATION_CREDENTIALS=KEY_PATH" (set GOOGLE_APPLICATION_CREDENTIALS="D:\study\sem2\sw project mgmt\assign 5\Assign 5 Code\code\LSTM-forecast\lstm-service-c6de08883d32.json") (Replace KEY_PATH with the path of the JSON file that contains your service account key.)
       ...
       (docker tag 0a53fa728b5b gcr.io/lstm-service/lstm-service)
      ...
      NOTE: For the environment variable, ".json" and "/" is mandatory in there respective environment variable value
       ...
       https://lstm-service-pckyyaqebq-uc.a.run.app
